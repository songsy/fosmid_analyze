...
def calc_phase_error(is_switch,switch_position):
...
#		print file1,file2
		...
		if args.prism=='1':
			...
			switch_point_length,switch_distance,switch_length,a,b,c=compare_phasing_v2(SNP,switch_point_length,switch_distance,switch_length)
		if b<a-b:
			different +=b
		else:
			different += a-b
